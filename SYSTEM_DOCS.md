...
| **withdrawal_requests**   | requested_by, type, amount, purpose, status, approved_by, approved_at, rejection_reason | Fund Disbursement   |
...
| `app/Http/Controllers/WithdrawalController.php` | Withdrawal request workflow |
...
| `app/Http/Controllers/ReportController.php` | Reports dashboard and export generation (donations, events, attendance, financial, gamification) |
...
| `app/Http/Requests/WithdrawalRequestForm.php` | Withdrawal request validation rules (incl. type field) |
...
| `app/Models/WithdrawalRequest.php` | Withdrawal workflow entity |
