...
@php
    $breadcrumbs = [
        ...
        ['label' => 'Badges', 'url' => route('admin.gamification.badges.index')],
        ['label' => isset($badge) ? 'Edit Badge' : 'New Badge'],
    ];
@endphp
...
<div class="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-4">
            <a href="{{ route('admin.gamification.badges.index') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 transition font-medium">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @elseif($badge->is_raw_svg)
                                            <span class="w-12 h-12 flex items-center justify-center text-3xl">@safe_svg($badge->icon_svg)</span>
                                        @endif
                                    </div>
...
{{-- Submit --}}
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mt-8 pt-6 border-t border-gray-200">
                    {{-- <button type="button" onclick="showConfirmDialog('Auto Fill Demo', 'This will fill in demo/test data. Are you sure?', 'Fill Data', 'bg-blue-400 hover:bg-blue-500', autoFillBadge)"
