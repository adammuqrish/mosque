...
<body class="bg-[#FAFAF5] font-sans antialiased flex flex-col min-h-screen pt-16">
    ...
    <nav class="fixed top-0 left-0 right-0 bg-emerald-800 text-white shadow-lg z-50 pattern-islamic" x-data="{ mobileOpen: false, dropdownOpen: false }">
        <div class="container mx-auto px-4 py-3">
                    ...
                    <div class="hidden lg:flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            @if(Auth::user()->role == 'admin')
                                ...
                                <a href="{{ route('admin.gamification.index') }}" class="bg-amber-500 hover:bg-amber-600 text-white text-xs px-3 py-1.5 rounded transition shadow-sm flex items-center gap-1" title="Gamification">
                                ...
                                <a href="{{ route('admin.settings') }}" class="bg-gray-500 hover:bg-gray-600 text-white text-xs px-3 py-1.5 rounded transition shadow-sm flex items-center gap-1" title="Settings">
            ...
            @auth
                <div x-show="mobileOpen" x-transition class="lg:hidden mt-4 pb-4 border-t border-emerald-600 pt-4">
                    <div class="flex items-center gap-3 mb-4 pb-4 border-b border-emerald-600">
                        @if(Auth::user()->avatar_url)
                    ...
                    <div class="space-y-1">
                        @if(Auth::user()->role == 'admin')
                            ...
                            <a href="{{ route('admin.gamification.index') }}" class="block px-4 py-3 rounded bg-amber-500 hover:bg-amber-600 transition flex items-center gap-3">
                        ...
                        @elseif(Auth::user()->role == 'treasurer')
                            <a href="{{ route('withdrawals.index') }}" class="block px-4 py-3 rounded bg-yellow-600 hover:bg-yellow-700 transition flex items-center gap-3 relative">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                        ...
                        @else
                            <a href="{{ route('gamification.dashboard') }}" class="block px-4 py-3 rounded bg-amber-500 hover:bg-amber-600 transition flex items-center gap-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                                {{ __('islamic.navigation.gamification') }}
                            </a>
